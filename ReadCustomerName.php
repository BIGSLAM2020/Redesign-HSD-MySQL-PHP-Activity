...
<html>
	<head>
		...
		<title>ReadCustomerName PHP Page</title>
		<style type="text/css">
	...
	<?php
	  ...
	  //$Conn = odbc_connect('sabdul','sabdul','pp2018');
    	...
    	$SQL = "SELECT EmailAddress, LastName, FirstName, Phone, City, State FROM CUSTOMER";
	...
	?>
	    ...
	    <h1>
	   		...
	   		<br />
	   		(EmailAddress, LastName, FirstName, Phone, City, State)
		</h1>
	    <hr />
	    <h2>
	        CUSTOMER
